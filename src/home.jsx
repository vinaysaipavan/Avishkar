...
export function Home() {
  ...
  useEffect(() => {
    ...
    let i = 0, j = 0, isDeleting = false, speed = 80, timeoutId;
    ...
    function typeEffect() {
      ...
      if (!isDeleting && j < current.length) {
        ...
        isDeleting = false; i = (i + 1) % phrases.length; speed = 300;
      }
      ...
      <div className="relative w-full h-screen overflow-hidden" id="home">
        ...
        <div className="relative z-10 flex flex-col items-center justify-center h-full px-4 text-center">
          ...
          <p className="text-lg sm:text-xl text-beige tracking-wider lg:tracking-[0.3em] px-2 max-w-4xl">
            <span ref={typedTextRef} className="min-h-[1.5em] inline-block text-emerald-200" />
          </p>
        </div>
      </div>
