...
export function Process() {
  return(
    <>
      <div class="process bg-slate-200 flex flex-col justify-center items-center min-h-[100vh] w-[100vw] z-10 relative">
        <div class="process-gradient absolute w-[100%] h-[100%] -z-50 top-0 left-0"></div>
          <h1 class="process-hero text-center font-bold mb-2.5">Our Process</h1>
            <p class="process-subhero text-center text-slate-200 py-2.5 text-lg px-5 mx-auto bg-orange-500">At Avishkar, we follow a structured process to ensure the successful delivery of high-quality applications that meet our clients' needs.</p>
            <div class="process-container">
              <div class="process-box relative bg-black">
                <div class="imgbox">
                ...
                <div class="process-content">
                  <div>
                    ...
                    <p>When clients approach us, we take time to understand their business model, goals, and application needs. By studying their industry, competitors, challenges, and market scope, we tailor our application development services to perfectly align with their objectives.</p>
                  </div>
                </div>
              </div>
